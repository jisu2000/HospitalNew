								...
								<div class="collapse" id="pagesCollapseError"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="addpatient.jsp">Add patient</a> <a
											class="nav-link" href="showallpat.jsp">Show all patient</a> <a
											class="nav-link" href="updatept.jsp">Modify patient</a>
									</nav>
								</div>
							</nav>
						</div>
				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4 mx-auto mt-6">
						...
						<table class="table table-dark">
							...
							<td><a href="updatedoct.jsp?id=<%=b.getId() %>" class="btn btn-sm btn-success"> Modify</a>
							<a href="deletedoct?id=<%=b.getId() %>" class="btn btn-sm btn-danger"> Delete</a>
