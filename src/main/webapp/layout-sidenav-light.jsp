					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								Show all Bookings
								</a> <a class="nav-link" href="layout-sidenav-light.jsp">Delete Bookings</a>
							</nav>
						</div>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4 align-items-center font-monospace " style="margin-left:30vw">Delete Bookings</h1>
