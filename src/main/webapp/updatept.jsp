		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="fs-5 text-center">Modify</p>
						...
						<form action="updatept" method="post">
							<div class="form-group">
									...
									Patient pt=service.findptId(id);
								...
								<label for="exampleInputEmail1">Name</label> <input type="text"
									...
									aria-describedby="emailHelp" value="<%=pt.getName()%>" placeholder="Enter Name">




								<label for="exampleInputEmail1">Email address</label> <input
									type="email" value="<%=pt.getEmail() %>" name="email" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp"
									placeholder="Enter email"> <label
									for="exampleInputEmail1">Contact no</label> <input
									type="number" name="cont" value="<%=pt.getCont() %>" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp"
									placeholder="Enter Your Contact no"> <label
									for="exampleInputEmail1">Address</label> <input type="text"
									name="address" class="form-control" value="<%=pt.getAddress() %>" id="exampleInputEmail1"
									aria-describedby="emailHelp" placeholder="Enter Your Address">

								<label for="exampleInputEmail1">Disease</label> <input
									type="text" name="dis" value="<%=pt.getDisease() %>" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp"
									placeholder="Enter disease">

								<label for="exampleInputEmail1">Condition</label> <input
									type="text" name="con" value="<%=pt.getCon()%>"class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp"
							...
							<div class="dropdown">
									<button class="btn btn-warning dropdown-toggle" type="button"
										...
										aria-expanded="false">Select Doctor And Update</button>
									<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
										<%
										MySQLDao serviceW = new MySQLDao();

										List<Doctor> list = serviceW.viewAllDoct();
